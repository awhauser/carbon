...
\includegraphics{head_foot/DOI} & \noindent\LARGE{\textbf{Nanoporous, two-dimensional carbon materials for gas separation}} \\
\vspace{0.3cm} & \vspace{0.3cm} \\

 & \noindent\large{Andreas W. Hauser,$^{\ast}$\textit{$^{a}$} and Peter Schwerdtfeger\textit{$^{b}$}} \\
...
\footnotetext{\textit{$^{a}$~Institute of Experimental Physics, Graz University of Technology, Petersgasse 16, A-8010 Graz, Austria; E-mail: andreas.w.hauser@gmail.com}}
\footnotetext{\textit{$^{b}$~Centre for Theoretical Chemistry and Physics (CTCP), The
New Zealand Institute for Advanced Study (NZIAS), Massey University
(Auckland Campus), Private Bag 102904, North Shore City, 0745
Auckland, New Zealand; E-mail: peter.schwerdtfeger@gmail.com}}
